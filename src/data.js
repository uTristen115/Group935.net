...
window.ZD = (function () {
  const games = [
    { id: 'waw', code: 'WaW', title: 'World at War', year: 2008, era: 'Origins of Origins', mapCount: 4, color: '#6a5232',
      imgDir: 'World at War',       imgBase: 'CoDWaW.png', imgHover: ['CoDWaWZ1.png','CoDWaWZ2.png'], imgLogo: 'WaWZombie.png', imgIcon: 'worldatwaricon.png' },
    { id: 'bo1', code: 'BO',  title: 'Black Ops', year: 2010, era: 'The Aether Story Begins', mapCount: 7, color: '#7a3b32',
      imgDir: 'Black Ops',          imgBase: 'CoDBO1.png', imgHover: ['CoDBO1Z.png'], imgLogo: 'BlackOpsZombiesLogo.png', imgIcon: 'boicon.jpg' },
    { id: 'bo2', code: 'BO2', title: 'Black Ops II', year: 2012, era: 'Maxis vs. Richtofen', mapCount: 5, color: '#3f5a6b',
      imgDir: 'Black Ops 2',        imgBase: 'CoDBO2.png', imgHover: ['CoDBO2Z.png'], imgLogo: 'bo2Logo.png', imgIcon: 'bo2icon.png', heroBasePosition: 'center bottom', heroHoverPosition: 'center 25%' },
    { id: 'bo3', code: 'BO3', title: 'Black Ops III', year: 2015, era: 'The Final Chapter', mapCount: 9, color: '#5a3a6b',
      imgDir: 'Black Ops 3',        imgBase: 'CoDBO3.png', imgHover: ['CoDBO3Z.png'], imgLogo: 'BO3Logo.png', imgIcon: 'bo3icon.png' },
    { id: 'bo4', code: 'BO4', title: 'Black Ops 4',  year: 2018, era: 'The Chaos Divergence', mapCount: 8, color: '#2f5a4a',
      imgDir: 'Black Ops 4',        imgBase: 'CoDBO4.png', imgHover: ['CoDBO4Z.png'], imgLogo: 'BOIIIILogo.png', imgIcon: 'bo4icon.png' },
    { id: 'cw',  code: 'CW',  title: 'Cold War',     year: 2020, era: 'The Dark Aether', mapCount: 5, color: '#3a4a6b',
      imgDir: 'Black Ops Cold War', imgBase: 'CoDCW.png',  imgHover: ['CoDCWZ.png'], imgLogo: 'CoDCWZLogo.png', imgIcon: 'bocwicon.png' },
  ...
  const maps = [
    ...
    { id: 'derriese',  game: 'waw', name: 'Der Riese', location: 'Group 935 main facility, Breslau', difficulty: 3, eeCount: 0, relicCount: 0, summary: '', tags: ['classic', 'teleporter', 'pack-a-punch'] },
    { id: 'kino',      game: 'bo1', name: 'Kino der Toten', location: 'Abandoned cinema, East Germany, 1960s', difficulty: 2, eeCount: 0, relicCount: 0, summary: '', tags: ['classic', 'teleporter', 'samantha'] },
...
Hiding in a closet at the Pentagon, Mcnamara records a message confirming that John F. Kennedy, Richard Nixon, and Fidel Castro have died as a result of a zombie outbreak. He dies moments later.`;
  ...
  const relics = [
    {
      ...
      effect: 'Loot-looking Mimic props can appear around the map. Approaching one can wake it up and turn a simple pickup check into a Mimic fight.',
      unlock: [
        'Reach round 20.',
        'Light the Lost Cabins candle inside the ruined fog cabin.',
        'Light the Farm House candle at Vandorn Farm.',
        'Light the Ashwood candle on the shelf next to Juggernog.',
        'Enter the Barnhouse portal after all three candles are lit.',
      ],
      portal: 'Barnhouse south side, beside the left door.',
      trial: 'Four Shock Mimic waves. Waves 1 and 3 are progress waves, while waves 2 and 4 ask you to burn down Mimic HVTs. Doppelghasts can join the HVT zombie waves, so do not tunnel only on the Mimic.',
      save: 'Unsafe after candle progress begins.',
      prep: ['Molotovs and Napalm Burst are the safest candle tools because they light candles without forcing a special weapon setup.', 'The candles can be lit in any order. Keep one or two zombies alive so you can move cleanly between regions without the round flipping.', 'Avoid throwing equipment directly into Mimic shock bursts because the burst can erase equipment before it does useful work.', 'Brain Rot is the cleanest ammo mod here because Mimics are weak to it and turned zombies help control the cramped waves.', 'A medium-range Pack-a-Punched bullet weapon is enough; save explosives or scorestreaks for emergency HVT zombie pressure.'],
    },
    {
      id: 'dragon-wings', map: 'ashes', tier: 'Grim', name: 'Dragon Wings', difficulty: 'Easy',
      cursed: 'Cursed Mode required; no Cursed Tier required.',
      effect: 'Standard power-up drops stop appearing, including special-round ammo drops, so ammo planning matters more on longer runs.',
      unlock: [
        'Reach round 20, then stage at Vandorn Farm with a fast-handling bullet weapon.',
        'Use the jump pad that launches from Vandorn Farm toward Janus Towers.',
        'During the launch, shoot the three purple airborne targets before landing.',
        'Enter the Farmhouse portal after the airborne target sequence succeeds.',
      ],
      portal: 'Northwest side of the Farmhouse.',
      trial: 'Power-ups become hazards and damage you on contact. Waves 1 and 3 build progress, while waves 2 and 4 bring Mimic HVTs.',
      save: 'Unsafe after the airborne target sequence.',
      prep: ['Treat the target sequence like one continuous jump rather than three separate attempts.', 'Raise look sensitivity before the jump if the targets feel too tight.', 'Bring a light, fast-handling bullet weapon for the target sequence rather than a launcher or slow Wonder Weapon.', 'Inside the trial, path around power-ups like floor traps. Do not slide through drops unless you are certain they are outside your movement lane.', 'Mimic HVT waves are still the real danger; keep armor topped off before entering so a bad power-up path does not stack with HVT zombie damage.'],
    },
    {
      id: 'teddy-bear', map: 'ashes', tier: 'Grim', name: 'Teddy Bear', difficulty: 'Easy',
      cursed: 'Cursed Mode required; no Cursed Tier required.',
      effect: 'The pause between rounds is heavily shortened, giving less time to reload, plate, buy ammo, or rotate before the next spawn set begins.',
      requirements: [
        'Equip Aether Shroud and bring the Necrofluid Gauntlet.',
        'You need 10 Aether Shroud charges, one for each Mr. Peeks doll. Power Keg is recommended to speed up the recharge work.',
      ],
      unlock: [
        'Reach round 20 before starting the Mr. Peeks doll collection.',
        'Collect the 10 Mr. Peeks dolls in any order. For each doll, charge Aether Shroud, activate it, then grab the doll with the Necrofluid Gauntlet while shrouded.',
        'Check these doll locations: Janus Tower Plaza gate toward Blackwater Lake, Vandorn Farm silo, Blackwater Lake upstairs bathroom near Speed Cola, Lost Cabins rooftop on the Ashwood side, Ashwood Church wall opening, Rabbit Alley burning room, Zarya Cosmodrome electric pole, Zarya Cosmodrome room beside the Crafting Table, Grounded Ship barrel area, and the Exit 115 highway sign.',
        'Enter the Vandorn Farm portal after the final doll is collected.',
      ],
      portal: 'Vandorn Farm, on the south wall of the Mystery Box building.',
      trial: 'Every weapon shot spends essence. Waves 1 and 3 build progress, and waves 2 and 4 bring Mimic HVTs that can drain your points fast if you spray.',
      save: 'Unsafe once the bear hunt starts.',
      prep: ['Start and finish the doll hunt in one session. A save during the hunt can break collection progress.', 'The Necrofluid Gauntlet keeps the arena cheap because it reduces how often you need to pay for gunfire.', 'Spend, bank, or stage your essence before entering. A long panic spray can erase a point stack quickly.', 'Use traps or high-value shots where possible, and save full-auto fire for Mimics that must die immediately.'],
    },
    {
      id: 'gong', map: 'astra', tier: 'Grim', name: 'Gong', difficulty: 'Easy',
      cursed: 'Cursed Mode required; no Cursed Tier required.',
      effect: 'Field Upgrades stop charging passively. You begin with a charge, but Full Power and other forced recharge tools become the main way back.',
      requirements: [
        'Equip Tesla Storm before starting the bulb sequence.',
        'Put Dead Wire on a weapon before starting the bulb sequence.',
      ],
      unlock: [
        'Reach round 20 with Tesla Storm equipped and Dead Wire on a weapon.',
        'Start a fresh round and identify the rod-marked zombie.',
        'Check the bulb above the Pack-a-Punch doorway toward the portal, the Luminarium doorway near Juggernog, and the Machina Astralis or library doorway near the Mars path.',
        'Move the rod-marked zombie in front of a target bulb, trigger Tesla Storm and Dead Wire weapon damage, then kill it close to the bulb.',
        'Repeat the rod-marked zombie kill for all three bulbs.',
        'Enter the Pack-a-Punch portal after all three bulbs are charged.',
      ],
      portal: 'Outside Pack-a-Punch, left of the Gobblegum machine.',
      trial: 'Only electric damage counts. Waves 1 and 3 build progress; wave 2 can pressure you with multiple Klaus zombies, and wave 4 can bring an Uber Klaus zombie.',
      save: 'Safe, but rod-zombie progress must be repeated after loading back in.',
      prep: ['A rod-marked zombie needs to die close enough to a charged bulb for that bulb to register.', 'If the rod-marked zombie dies too far away, the bulb can fail to charge and the zombie may not return that round.', 'Dead Wire with Light Strike and Haste makes the bulb setup more forgiving because the electric trigger can happen on demand more often.', 'Tesla Storm duration or radius augments can cover a mistake if the horde piles up while you are positioning a rod-marked zombie.', 'Ping the rod-marked zombie for co-op tracking, and avoid splash damage until it is standing where you want it.'],
    },
    {
      ...
      unlock: [
        'Reach round 20, then pick up the grey pistol only when you are ready to count kills.',
        'Kill exactly the same number of zombies as the round number when you collected the pistol. For example, a pickup on round 20 means exactly 20 pistol kills.',
        'Check the Observatory Dome wall or lower telescope area, the Luminarium dirt pile or Ammo Cache path, the Machina Astralis bar counter, and the Archives of Orbis bookshelf lane for the pistol.',
        'Finish the round with a different weapon once the pistol kill count matches the pickup round.',
        'Enter the Observatory Dome portal after the round ends.',
      ],
      portal: 'Observatory Dome, left side near the Ammo Cache.',
      trial: 'Fight through four waves with a Pack-a-Punch I pistol. Waves 1 and 3 are progress waves; the HVT zombie waves can include Klaus zombies, a Mimic, and finally an Uber Klaus zombie.',
      save: 'Unsafe; the pistol can disappear after a reload.',
      prep: ['Use the weapon stats screen to verify the pistol count, and stop immediately when it matches the round.', 'Avoid passive kill sources like Elemental Pop or Wisp Tea while counting because they can muddy the exact pistol total.', 'Rarity upgrades and Insta-Kill help the pistol feel less weak, but Pack-a-Punching during the count can be risky if your setup has shown pickup glitches.', 'Bring a second weapon specifically for finishing the round after the pistol count is locked.'],
    },
    {
      ...
      unlock: [
        'Before round 20, use past Nuketown to turn a Rad Hound zombie friendly and pet it.',
        'On round 20, move to destroyed or future Nuketown and deploy a D.A.W.G. scorestreak.',
        'Put the D.A.W.G. in a stable position, save a zombie, and pet it as the round state resolves so the interaction registers.',
        'Enter the Green House portal after both pet interactions register.',
      ],
      portal: 'Past Nuketown, upstairs in Green House while facing south.',
      trial: 'Zombies only take meaningful damage from their elemental weaknesses. Waves 1 and 3 build progress; HVT zombie waves usually mix Rad Hound zombies, Doppelghasts, and Mimics.',
      save: 'Unsafe; pet progress does not persist cleanly.',
      prep: ['Psych Grenades are the cleanest way to make the friendly Rad Hound zombie pet window predictable.', 'Look directly at the pet target during the interact prompt. Side angles can miss the prompt and waste the round setup.', 'Do the Rad Hound zombie and D.A.W.G. steps in one run; pet progress is not a save-safe chain.', 'Carry separate ammo mods instead of relying on one weapon: Shadow Rift for toxic zombies, Light Mend for Doppelghasts, and Brain Rot for Mimics.', 'Golden Armor, a self-revive, and Aether Shroud give the trial room for mistakes when the wrong weakness is in front of you.', 'Do not spend the whole trial swapping blindly. Identify the HVT zombie, then commit the weapon that matches its weakness.'],
    },
    {
      id: 'power-switch', map: 'totenreich', tier: 'Grim', name: 'Power Switch', difficulty: 'Very Easy',
      cursed: 'Cursed Mode required; no Cursed Tier required.',
      effect: 'Your lethal and tactical equipment changes at the start of each round, so long-term equipment planning becomes unreliable.',
      requirements: [
        'Bring Scavenger Aid and a Combat Axe, the tomahawk-style lethal, before starting the shield sequence.',
      ],
      unlock: [
        'Reach round 20, then check the deer-head altars outside the playable map at Eidskallen Landing, Dry Dock, Tyr\'s Foot, and Burial Grounds.',
        'Count the skulls on each deer-head altar to determine the shield order.',
        'Go to the Stave Church and use Scavenger Aid to read the shields.',
        'Throw the Combat Axe at the shields in the order given by the deer-head altar skull counts.',
        'Enter the Blodheim Hall portal after the shield sequence is accepted.',
      ],
      portal: 'Blodheim Hall, south-wall bear pelt.',
      trial: 'Trap kills only. The trial is only three waves, so lead zombies through the map machinery instead of trying to finish them with weapons.',
      save: 'Safe.',
    ...
    },
    {
      ...
      cursed: 'Cursed Mode Tier 1, 2, or 3 required.',
      effect: 'The perk limit drops to four unless another reward bypasses the cap.',
      unlock: [
        'Reach round 40, then isolate a Doppelghast without killing it outright.',
        'Lower its health before starting the jump-pad setup.',
        'Lead the damaged Doppelghast onto any jump pad and launch with it.',
        'Let the jump-pad landing finish the Doppelghast.',
        'Enter the Zarya Cosmodrome portal after the landing kill registers.',
      ],
      portal: 'Zarya Cosmodrome, high middle road while looking east.',
      trial: 'Purchases are disabled during the arena. Waves 1, 3, and 4 build progress; waves 2 and 5 bring Mimic and Doppelghast HVT waves.',
      save: 'Safe before round 40.',
      prep: ['The jump-pad landing needs to finish the Doppelghast, so do not leave it at full health.', 'Stay close enough that the Doppelghast follows the jump path. If it falls behind or dies early, repeat with another Doppelghast.', 'Open doors, buy armor, fill ammo, and craft equipment before entering because the trial shuts purchases off.', 'A Pack-a-Punch III Necrofluid Gauntlet can carry most of the trial while keeping ammo spending predictable.', 'Use the lower Cosmodrome training space before entering to reset armor and equipment if the jump-pad setup took damage.'],
    },
    {
      ...
      unlock: [
        'Before round 40, feed Chompy one weapon from each rarity tier: common, uncommon, rare, epic, and legendary.',
        'On round 40 or later, place a Wonder Weapon into the Chompy bin to finally open the portal.',
        'Enter the Zarya Cosmodrome portal after the Wonder Weapon deposit registers.',
      ],
      portal: 'Zarya Cosmodrome, along the path toward Yuri\'s Lab.',
      trial: 'Ammo Caches and Max Ammo drops are unavailable. Waves 1, 3, and 4 build progress; waves 2 and 5 can lean heavily on Doppelghast HVTs, with Mimics possible.',
      save: 'Unsafe once Chompy progress has started.',
      prep: ['Start with a grey pistol as early as possible so the common tier is not left until the round climb.', 'Listen for Chompy before depositing a weapon. If the bin is quiet, do not sacrifice an important gun into the wrong state.', 'Do the chain in one session. The rarity sacrifices are not reliable after saving.', 'Mule Kick with extra stock ammo makes the no-ammo-cache trial more forgiving.', 'Enter with full magazines and a weapon that has comfortable reserves, because a long HVT zombie wave can punish reload-heavy builds.', 'Keep Wonder Weapon ammo for HVT zombies instead of spending it on low-threat zombies.'],
    },
    {
      ...
      unlock: [
        'Reach round 40, then damage a Zursa until a knife strike will finish it.',
        'Collect the bottle dropped by the knife-finished Zursa.',
        'On round 40 or later, complete the legendary TEDD Task and collect the second bottle near the task reward.',
        'Carry both bottles to the Blackwater Lake wine bar.',
        'After placing the bottles, watch the burst order immediately. When the bottles reset, shoot them in the same order to open the portal.',
      ],
      ...
      save: 'Safe before round 40.',
      prep: ['The TEDD Task bottle can appear near the task reward rather than directly on top of it.', 'Pay attention the instant the bottles are placed, because the order cue happens quickly.', 'Spend or craft before entering the trial; any unspent essence will be stripped anyway.', 'A Pack-a-Punch III Necrofluid Gauntlet keeps the no-essence trial simple because you are less dependent on ammo buys.'],
    },
    {
      ...
      unlock: [
        'Reach round 40 or later without advancing main quest steps that can disrupt OSCAR.',
        'Activate Wisp Tea so a wisp is active on OSCAR.',
        'Lower OSCAR carefully, then make sure a wisp is active on OSCAR before the final hit.',
        'Kill OSCAR with a melee weapon while Wisp Tea is active.',
        'Enter the Archives of Orbis portal after the OSCAR melee finisher registers.',
      ],
      portal: 'Archives of Orbis, opposite Stamin-Up.',
      trial: 'All perks are stripped when the trial starts. Waves 1, 3, and 4 build progress; wave 2 can bring an Uber Klaus zombie, and wave 5 can bring OSCAR.',
      save: 'Unsafe once OSCAR health setup is underway.',
      prep: ['Progression state can make the OSCAR setup much less predictable.', 'Use Wisp Tea augments that keep the wisp from wasting normal zombies and extend the active window.', 'If OSCAR survives into very high rounds, use controlled Ray Gun or knife damage to lower health, then stop early enough that the melee finisher is still possible.', 'A legendary Pack-a-Punch III knife gives the cleanest final-hit attempt.', 'Insta-Kill GobbleGums and Aether Shroud make the melee finisher much easier to secure.', 'The Apogee Annihilator and War Machines help lower HVT zombie health during the trial after your perks are removed.', 'Be patient with this setup. It is one of the most sensitive relic unlocks, and rushing the last hit usually causes the miss.'],
    },
    {
      ...
      unlock: [
        'Open the Mars portal before round 40.',
        'On Mars, place C4 on the three meat piles around the lower center stage.',
        'Train a large zombie horde onto the stage before detonating.',
        'Detonate the C4 when the horde is centered and the stage is clear enough for you to survive the blast window.',
        'After the detonation registers, leave Mars and check the Machina Astralis portal area.',
      ],
      portal: 'Machina Astralis, by the Cryopod.',
      trial: 'Zombie kills only count while a Field Upgrade is active. Waves 1, 3, and 4 build progress; later HVT zombie waves can include Uber Klaus and OSCAR.',
      save: 'Safe after Mars is open and before round 40.',
      prep: ['Opening the Mars portal before round 40 keeps the high-round setup shorter and safer.', 'The trigger appears to care about a meaningful zombie group kill rather than a single cleanup explosion.', 'Aether Shroud is the easiest progress button because the active window lets you kill zombies without taking much return fire.', 'Frenzied Guard is the stronger co-op or safety option if you need armor and zombie control.', 'Do not waste the Field Upgrade on low-density spawns. Gather a wave, activate, then spend the full window.'],
    },
    {
      id: 'summoning-key', map: 'paradox', tier: 'Sinister', name: 'Summoning Key', difficulty: 'Medium',
      cursed: 'Cursed Mode Tier 1, 2, or 3 required.',
      effect: 'Zombies explode when killed, and the blast can damage you if you stay too close to the body.',
      unlock: [
        'In Pre-Nuke Nuketown, throw a grenade into the broken chimney near the clock and pick up the dog collar that drops.',
        'In the Yellow House backyard on Pre-Nuke Nuketown, use Brain Rot to turn a Rad Hound zombie.',
        'Let the turned Rad Hound zombie dig up the ball, then collect the ball.',
        'On round 40 or later, down yourself in the garden behind the Green House so the grave rises.',
        'Interact with the grave to place the dog collar and ball.',
        'Enter the Yellow House portal after the grave interaction opens it.',
      ],
      portal: 'Yellow House, southwest outside wall.',
      trial: 'Each wave has a timer, and every zombie must die before time expires. Waves 1, 3, and 4 build progress, while waves 2 and 5 can mix Rad Hound zombies with Doppelghast HVTs.',
      save: 'Unsafe after collecting the dog collar.',
      prep: ['Equivalent Exchange or Aftertaste can protect the intentional down and keep the setup from costing the run.', 'A low-rarity Brain Rot pistol is less likely to kill the Rad Hound zombie before it digs up the ball.', 'Ray Gun, Kazimirs, Free Throw, and War Machine pressure are excellent for timed clears.', 'Keep distance after zombie kills during both setup and trial, because the relic effect turns close-range cleanup into chip damage.'],
    },
    {
      ...
      unlock: [
        'Reach round 40 without buying perks from machines or taking perk rewards that could invalidate the no-perk state.',
        'Once round 40 is reached cleanly, rotate to Fishery Island and check for the portal before buying anything.',
      ],
      portal: 'Fishery Island, southeast corner behind the eastern building.',
      trial: 'Find cursed eggs, destroy them, and kill the HVT zombie before the timer ends. The target sequence can rotate through Necropincers, Doppelghasts, Amalgam zombies, and Zursa.',
      save: 'Unsafe; complete the no-perk run in one session.',
      prep: ['Perkaholic before the first round marker may sometimes slip through, but do not rely on that for a clean tutorial attempt.', 'Cursed Tier III and Pack-a-Punch IV planning make the no-perk climb less fragile.', 'Toxic Growth can hold safer areas like the jail cell or upper Lighthouse while you build points.', 'Look for eggs at Beacon Island or Lighthouse, Skallen Market, Storm Bridge near Tyr\'s Foot, and the Dry Dock Mystery Box room.', 'Toxic Growth and a high-tier Jotunn Star make the no-perk climb safer.', 'Do not take perks from machines, GobbleGums, TEDD Tasks, or Mr. Peeks if you want the reliable portal spawn.', 'Learn the egg sightlines before starting the timed trial, because the timer punishes searching from scratch.'],
    },
    {
      ...
      unlock: [
        ...
        'Collect the pot under the southwest Skallen Market food stand and the ale on the barrel by the porch near the Eidskallen Square to Fishery Island zipline.',
        'Blow open the bridge truck crate and collect the Chili Chunks.',
        'Kill a Necropincer with the fire trap to claim the claw, then on round 40 or later use the fishing rod to pull the red fish.',
        'After placing the ingredients, use Jotunn Star kills around the dancing Mr. Peeks until the portal opens.',
      ],
      portal: 'Fishery Island, northeast corner opposite the Mystery Box spot.',
      trial: 'Melee kills only. Waves 1, 3, and 4 build progress; HVT zombie waves can bring Necropincers first, then Necropincer and Zursa later.',
      save: 'Unsafe once the recipe chain begins.',
      prep: ['Get the Chili Chunks from the bridge crate early, before the truck can create progression conflicts.', 'Melee Macchiato speed and backpedal augments help the trial flow because you need to score zombie kills without being pinned.', 'Golden Armor and a Pack-a-Punch IV Jotunn Star make the melee-only trial much safer.', 'Treat the HVT zombie waves as spacing checks: chip the target, back out, then return for the melee kill instead of standing still.'],
    },
    {
      id: 'bus', map: 'ashes', tier: 'Wicked', name: 'Bus', difficulty: 'Medium',
      cursed: 'Cursed Mode Tier 2 or 3 required.',
      effect: 'Zombie health regenerates.',
      unlock: [
        'Reach round 60 before attempting the no-damage round.',
        'Complete a full round without taking damage. You can kill zombies normally; the unlock checks whether you were hit, not whether you dealt damage.',
        'Enter the Blackwater Lake portal after the no-damage round registers.',
      ],
      portal: 'Blackwater Lake, north side of the boathouse.',
      trial: 'Only Brain-Rotted ally zombies can damage zombies. Waves 1, 2, 4, and 5 build progress; waves 3 and 6 can bring Doppelghast and Zursa HVTs, with Mimics possible.',
      save: 'Safe before round 60.',
      prep: ['Use whatever weapons, equipment, or traps help you finish the round safely; damage dealt by you does not invalidate the unlock.', 'Wide training spaces and escape tools like Aether Shroud, Idle Eyes, Decoys, or Kazimirs help prevent a stray hit near the end of the round.', 'Avoid self-damage, trap damage, fall damage, and explosive splash while attempting the no-damage round.', 'Brain Rot augments that improve area damage, trigger rate, and ally damage speed up the trial dramatically.', 'Use a high-rarity Pack-a-Punched assault rifle or SMG to trigger Brain Rot reliably, then stop shooting and let the ally zombie work.', 'Do not panic-shoot HVT zombies if they are not Brain-Rotted; the trial rule only rewards the turned ally zombie damage.'],
    },
    {
      ...
      unlock: [
        'Reach round 60 or later, then complete the Cursed boss fight.',
        'Enter the Blackwater Lake portal after the Cursed boss fight completion registers.',
      ],
      ...
      save: 'Safe before round 60.',
      prep: ['Build perks early and try to make Quick Revive permanent before the Cursed boss fight.', 'Bring Kazimirs or Monkey Bombs so Tessie repairs do not collapse during heavy pressure.', 'Save Aether Shroud or another escape button for the final boss phase rather than spending it early.', 'PhD Flopper protection is mandatory for comfortable close-range explosive play.', 'Ray Gun, Kazimirs, and War Machines are the trial core. Craft extra War Machines before entering if your economy allows it.', 'Use explosives to create space first, then focus HVT zombies once the normal wave is under control.'],
    },
    {
      ...
      unlock: [
        ...
        'Check the Janus Towers server room, Zarya control room, Blackwater Lake tool shed, Vandorn Farm first floor, Ashwood market, Exit 115 service areas, and Lost Cabins for the ringing phone.',
        'Enter the Blackwater Lake cabin portal after the round-60 phone is answered.',
      ],
      ...
      prep: ['Hold several zombies on each phone round so you can search without accidentally moving to the next round.', 'Listen for the ring while using jump pads to cover distance quickly.', 'If the hold is taking too long, kill one zombie every few minutes so the round does not flip from despawn behavior while you search.', 'Wonder Weapons and War Machines still handle the reduced-damage HVT zombies well because the damage penalty is more punishing for ordinary bullet weapons.', 'Do not enter under-armored; the longer time-to-kill gives HVT zombies more chances to hit you.', 'Because augments are disabled by the relic effect, plan the trial around raw weapon strength rather than build-specific perk bonuses.'],
    },
    {
      id: 'golden-spork', map: 'astra', tier: 'Wicked', name: 'Golden Spork', difficulty: 'Medium',
      cursed: 'Cursed Mode Tier 2 or 3 required.',
      effect: 'Incoming zombie damage is doubled.',
      unlock: [
        'Open the Mars portal before round 60.',
        'After round 60, equip a Mangler Cannon and bring Decoys to the Mars return portal.',
        'Fire a Mangler Cannon shot into the portal that sends you back from Mars to the map.',
        'Take the same portal yourself before the shot arrives.',
        'On the map side, throw Decoys and pull as many zombies as possible near the portal exit.',
        'After about 10 seconds, the Mangler Cannon shot follows you through the portal and detonates. Let that teleported shot kill the grouped zombies.',
        'Enter the Crash Site portal after the teleported Mangler Cannon kill registers.',
      ],
      portal: 'Crash Site, north of Quick Revive on the wall right of the Gobblegum machine.',
      trial: 'Only hip-fire damage counts. Waves 1, 2, 4, and 5 build progress; waves 3 and 6 can bring Klaus zombies, Mimics, Uber Klaus zombies, and an OSCAR HVT.',
      save: 'Safe after Mars is open and before round 60.',
      prep: ['Carry at least three Decoys so you can stack zombies where the portal shot exits.', 'If the teleported Mangler Cannon shot does not kill enough zombies, rebuild the group and repeat the portal shot.', 'Pack-a-Punch III LGM-1 and Ray Gun hip-fire well because they stay effective without aiming down sights.', 'War Machines do not satisfy the hip-fire rule, so keep them for safety outside progress moments rather than expecting them to advance the bar.', 'Maintain extra distance because the relic effect doubles incoming zombie damage, making small positioning mistakes much sharper.'],
    },
    {
      ...
      requirements: [
        'Equip Energy Mine before starting the Tessie light-code sequence.',
      ],
      unlock: [
        'Reach round 60, then activate Energy Mine next to Tessie.',
        'Let Energy Mine get a kill near Tessie so the car turns on.',
        'Watch Tessie flash her headlights three times. That signal means the light-code sequence is ready.',
        'Read the four-light code Tessie flashes: Tessie\'s front-left light is A, front-right is B, back-left is C, and back-right is D.',
        'Translate the letters to chandeliers in the Speed Cola room: A is front-left, B is front-right, C is back-left, and D is back-right.',
        'Use PhD Flopper under the matching chandeliers in code order.',
        'Enter the Crash Site portal after the chandelier sequence registers.',
      ],
      portal: 'Crash Site, upper level by Quick Revive on the left wall before the left door.',
      trial: 'Every zombie sprints. Waves 1, 2, 4, and 5 build progress; waves 3 and 6 can bring Klaus zombies, Mimics, Uber Klaus zombies, and an OSCAR HVT.',
      save: 'Safe before round 60.',
      prep: ['Sliding can work for the chandelier sequence, but a direct PhD flop is usually easier to line up.', 'Hold four or five zombies at the end of the round so the Tessie read is not rushed.', 'Write down the four-letter code before moving to the chandeliers.', 'Idle Eyes or Time Out can freeze the room long enough to perform the chandelier sequence without losing the code.', 'Stamin-Up speed augments are worth more than usual because the entire arena is sprint pressure.', 'The Apogee Annihilator helps erase normal zombies and lower HVT zombie health without needing long stationary aim windows.', 'Keep moving through wide paths instead of defending a corner; the trial punishes every pause.'],
    },
    {
      ...
      requirements: [
        'Do not activate the Seed relic for this run. Seed disables the Mystery Box, and this unlock requires the Mystery Box in both Pre-Nuke and Post-Nuke Nuketown.',
        'Equip the Mr. Peeks Field Upgrade before starting the Mystery Box sequence.',
      ],
      unlock: [
        'Charge the Mr. Peeks Field Upgrade.',
        'In Pre-Nuke Nuketown, spin the Mystery Box until Mr. Peeks appears and the box is about to move.',
        'Activate the charged Mr. Peeks Field Upgrade beside that Mystery Box so Mr. Peeks steals himself from the box and drops himself on the floor.',
        'Pick up the dropped Mr. Peeks from the floor.',
        'Repeat the same Mystery Box theft in Post-Nuke Nuketown. The Pre-Nuke and Post-Nuke pickups can be done in either order.',
        'Place the two Mr. Peeks pickups on the mailboxes in front of the Yellow House in both Pre-Nuke and Post-Nuke Nuketown.',
        'Reach round 60 and open the mailbox to take the ultra-rarity knife.',
        'When the HVT Mimic spawns, kill it using only that knife.',
        'Enter the Green House balcony portal after the HVT Mimic knife kill registers.',
      ],
      portal: 'Green House balcony.',
      trial: 'Survive six waves with reduced health and no armor. Waves 1, 2, 4, and 5 build progress; waves 3 and 6 can bring a Doppelghast HVT or one or more Rad Hound HVT zombies.',
      save: 'Safe before round 60, but the Mr. Peeks Mystery Box sequence must be repeated after a reload.',
      prep: ['Pack-a-Punch the ultra-rarity knife if needed, but do not mix in bullet or equipment damage on the HVT Mimic.', 'Ray Gun or Sundergat should stay in hand whenever possible so you can clear space without armor.', 'Make Quick Revive with Dying Wish permanent before attempting the trial.', 'Extra health, Free Throw, Mask of Distraction, PhD slide movement, Kazimirs, and War Machines are all high-value safety tools.', 'Keep distance at all times. Reduced health plus no armor makes greedy HVT zombie damage the fastest way to lose the run.'],
    },
    {
      ...
      unlock: [
        'Start the match as Richtofen.',
        'Use the ARC-XD path into the Group 935 Genetic Lab, solve the labeled-jar puzzle, craft the Necrospike, and pick up the handheld radio from the cell area.',
        'Use Tyr\'s Head exits until you collect Mr. Peeks from Ava\'s room and the helmet from the Requiem corpse room.',
        'On round 15 or later, buy Melee Macchiato and open the Core Foundry barrel to start the Richtofen side sequence.',
        'Wait for Von List to leave the chair, then place the collected items on it to complete the side setup.',
      ],
      portal: 'Dry Dock, upper west wall opposite the zipline.',
      trial: 'Zombies only count when killed indoors. Waves 1, 2, 4, and 5 build progress; later HVT zombie waves can include Necropincers, Doppelghasts, and Zursa.',
      save: 'Unsafe after the Richtofen side-quest setup is completed.',
      prep: ['This unlock is character-locked, so confirm the operator before investing in the setup.', 'The portal can currently be opened early, but the trial still behaves like a round-60-health arena, so do not enter underbuilt.', 'Either hold upstairs Lighthouse with Toxic Growth or train patiently and pull HVT zombies indoors before landing the kill.', 'Free Throw, Mask of Distraction, PhD slide movement, and War Machines are strong safety tools.', 'If you open the portal early, spend the extra rounds building Ray Gun, Mustang and Sally, or Jotunn Star strength before starting the arena.'],
    },
    {
      id: 'music-box', map: 'totenreich', tier: 'Wicked', name: 'Music Box', difficulty: 'Hard',
      cursed: 'Cursed Mode Tier 2 or 3 required.',
      effect: 'Zombies only die to critical kills.',
      unlock: [
        'Reach round 60.',
        'Enter Tyr\'s Head and land five zombie headshot kills in one visit.',
        'Enter the Dry Dock portal after the headshot sequence registers.',
      ],
      portal: 'Dry Dock, far west by the blocked staircase near Fjord Road.',
      trial: 'Activate six holdout circles marked by purple beams, then survive as each safe zone shrinks. The circle order is Fishery Island, Tyr\'s Foot, Dry Dock, Beacon Island, Eidskallen Square, then Skallen Market.',
      save: 'Safe before round 60.',
      prep: ['Save two zombies on a frost round if possible, then move to a spawn area close to your preferred Tyr\'s Head exit.', 'For solo, stack zombies near Skallen Market with decoys, then use Kill Joy and Idle Eyes before entering Tyr\'s Head.', 'A scoped Shadow SK plus Temporal Gift and Kill Joy creates the cleanest one-minute headshot window.', 'If the trigger fails, rebuild the horde and repeat with a calmer entry rather than forcing shots through bad spacing.', 'Cache Back, Shields Up, Kill Joy, and Kazimirs smooth the later holdouts.', 'Save War Machine pressure for waves 5 and 6, where the safe zones are smallest and Necropincer pressure spikes.', 'Do not be afraid to throw Kazimirs when boxed. The holdout fails from getting trapped more often than from slow progress.', 'Frenzied Guard with extra armor and longer duration can stabilize the final circles if you prefer a defensive Field Upgrade.'],
    },
  ];
  ...
  const extraMaps = [
    ...
    { id: 'thegiant', game: 'bo3', name: 'The Giant', location: 'Group 935 facility, 1945', difficulty: 3, eeCount: 0, relicCount: 0, summary: '', tags: ['primis', 'factory', 'teleporter'] },
  ...
  // ─── per-game content (gobblegums / augments) ────────────────
  ...
  const bo7Gobblegums = [
    {
      ...
      rarity: 'rare',
      type: 'conditional',
      image: 'aftertasteball.png',
      newInBo7: true,
      availableIn: ['BO7'],
      effect: 'After being revived, you keep your Perks.',
      doa4: 'Your next death does not remove shields or chickens.',
      use: 'Best as insurance after a Perkaholic, during high-round recoveries, or while someone is focused on a quest interaction.',
    },
    {
      id: 'kill-joy',
      name: 'Kill Joy',
      ...
      image: 'killjoy.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'Creates an Insta-Kill Power-Up in front of the user.',
      doa4: 'Turns on Insta-Kill for 60 seconds, excluding bosses.',
      use: 'Use it for quick objective pushes, safer revives, or a fast Essence burst when paired with Double Points.',
    },
    {
      id: 'cache-back',
      name: 'Cache Back',
      ...
      image: 'cacheback.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'Creates a Max Ammo Power-Up.',
      doa4: 'Equips a max-power Ray Gun with unlimited ammo for 15 seconds.',
      use: 'Coordinate with the squad before chewing it so the Max Ammo lands when several players need it most.',
    },
    {
      id: 'temporal-gift',
      name: 'Temporal Gift',
      rarity: 'rare',
      type: 'conditional',
      image: 'temporalgift.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'The next time-based Power-Up you activate lasts longer.',
      doa4: 'The next Power-Up lasts twice as long and can stack with Fate of Fortune.',
      use: 'Save it for valuable timed Power-Ups like Insta-Kill or Fire Sale, especially in solo runs.',
    },
    {
      id: 'stock-option',
      name: 'Stock Option',
      rarity: 'rare',
      type: 'timed',
      image: 'stockoption.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'For 60 seconds, firing pulls ammo from reserves instead of the magazine.',
      doa4: 'All players receive an Ammo pickup that upgrades the current weapon and prevents ammo drain for 15 seconds.',
      use: 'Great with high-reserve weapons, tight escape routes, and other timed damage boosts where reloads waste uptime.',
    },
    {
      ...
      rarity: 'rare',
      type: 'instant',
      image: 'anywherebuthere.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'Teleports you to a random location and blasts nearby zombies away.',
      doa4: 'Grants one five-minute chicken, usable once every 10 minutes.',
      use: 'Keep it for emergency repositioning, regrouping with the team, or crossing the map when fast travel is not practical.',
    },
    {
      id: 'power-keg',
      name: 'Power Keg',
      ...
      image: 'powerkeg.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'Creates a Full Power Power-Up.',
      doa4: 'Friendly concussive waves spawn at your location for 60 seconds.',
      use: 'Pair it with Arsenal Accelerator or a spent Field Upgrade to keep revive tools and crowd control online.',
    },
    {
      id: 'tactical-diffusion',
      name: 'Tactical Diffusion',
      rarity: 'rare',
      type: 'conditional',
      image: 'tacticaldiffusion.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'The next Nuke Power-Up you take is defused and every player receives 2,000 Essence.',
      doa4: 'Up to three Nukes used in the next 90 seconds also award $2,000 for Slayer Mart spending.',
      use: 'Use it early or before a planned Nuke pickup to turn a risky round-clear into team economy.',
    },
    {
      ...
      rarity: 'rare',
      type: 'timed',
      image: 'arsenalaccelerator.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'Field Upgrade charge rate is increased for 5 minutes.',
      doa4: 'Triggers three Energy Mines within 30 seconds.',
      use: 'Pop it right after spending a Field Upgrade, during solo pressure, or while learning a quest step.',
    },
    {
      id: 'shields-up',
      name: 'Shields Up',
      ...
      image: 'shieldsup.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'Refills armor and doubles armor strength for 3 minutes.',
      doa4: 'Grants a Barrel and Sawblade item for up to five minutes.',
      use: 'Use it before a dangerous revive, a solo escape, or any fight where armor is your margin for error.',
    },
    {
      id: 'reequipment',
      name: 'Reequipment',
      rarity: 'epic',
      type: 'timed',
      image: 'reequipment.png',
      newInBo7: true,
      availableIn: ['BO7'],
      effect: 'Equipment slots refill over 5 minutes.',
      doa4: 'Gives a random set of four Nukes and Boosts.',
      use: 'Good for long fights, Salvage conservation, and keeping Decoys or other quest-friendly gear stocked.',
    },
    {
      id: 'power-vacuum',
      name: 'Power Vacuum',
      rarity: 'epic',
      type: 'timed',
      image: 'powervacuum.png',
      newInBo7: true,
      availableIn: ['BO7'],
      effect: 'Kills have a higher Power-Up spawn chance for 5 minutes.',
      doa4: 'Enemy kills can spawn helpful items for five minutes.',
      use: 'Activate shortly after a round starts so the timer is spent on kills instead of downtime.',
    },
    {
      id: 'respin-cycle',
      name: 'Respin Cycle',
      rarity: 'epic',
      type: 'instant',
      image: 'respincycle.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'Rerolls a settled Mystery Box weapon into one of equal or higher rarity.',
      doa4: 'Awards either a helicopter or tank vehicle item.',
      use: 'Strong after Wonderbar! or Crate Power when the box result is not the one you need.',
    },
    {
      id: 'dead-drop',
      name: 'Dead Drop',
      ...
      image: 'deaddrop.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'Salvage and Equipment drop rates are greatly increased for 5 minutes.',
      doa4: 'Weapon drops appear at roughly five times the normal rate for five minutes.',
      use: 'Use a round before a boss or quest fight so the extra Salvage can become Ammo Mods, Support, or crafted gear.',
    },
    {
      id: 'whos-keeping-score',
      name: 'Who\'s Keeping Score?',
      rarity: 'epic',
      type: 'instant',
      image: 'whoskeepingscore.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'Creates a Double Points Power-Up.',
      doa4: 'Treasure spawns at roughly five times the normal rate for five minutes.',
      use: 'Trigger it when a full horde is ready, or combine it with Kill Joy for fast, low-risk Essence.',
    },
    {
      id: 'free-fire',
      name: 'Free Fire',
      ...
      image: 'freefire.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'For 60 seconds, firing normal weapons does not consume ammo. Wonder Weapons and underbarrels are excluded.',
      doa4: 'All players spend no ammo for 60 seconds.',
      use: 'Save it for bosses, HVTs, or objective holds where sustained weapon damage matters.',
    },
    {
      id: 'exit-strategy',
      name: 'Exit Strategy',
      rarity: 'epic',
      type: 'instant',
      image: 'exitstrategy.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'Starts an Exfil vote immediately and reduces the enemy count required during Exfil.',
      doa4: 'Chicken eggs hatch coins for 30 minutes.',
      use: 'Use it to leave a high-pressure match, salvage a missed Exfil window, or complete an Exfil challenge.',
    },
    {
      id: 'profit-sharing',
      name: 'Profit Sharing',
      rarity: 'epic',
      type: 'timed',
      image: 'profitsharing.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'For 2 minutes, nearby players share part of the Essence they earn with each other.',
      doa4: 'Chicken eggs hatch extra cash that is split evenly across teammates for 30 minutes.',
      use: 'Activate while grouped up so everyone can reach Pack-a-Punch, armor, or wall-buy thresholds faster.',
    },
    {
      id: 'explosive-flourish',
      name: 'Explosive Flourish',
      rarity: 'epic',
      type: 'timed',
      image: 'explosiveflourish.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'For 2 minutes, reloading creates an explosion around you.',
      doa4: 'Equips a max-power RPG with unlimited ammo for two minutes.',
      use: 'Pairs well with faster reloads and Electric Cherry-style effects for close-range control.',
    },
    {
      id: 'soda-fountain',
      name: 'Soda Fountain',
      rarity: 'epic',
      type: 'conditional',
      image: 'sodafountain.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'Your next Perk purchase also grants an extra random Perk.',
      doa4: 'Items spawn at about four times their usual rate for up to five minutes.',
      use: 'Buy common, easy-to-reach Perks first so the bonus is more likely to fill a harder-to-get slot.',
    },
    {
      id: 'nowhere-but-there',
      name: 'Nowhere But There',
      rarity: 'epic',
      type: 'instant',
      image: 'nowherebutthere.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'Teleports you to a random downed player and instantly revives nearby players.',
      doa4: 'Restores minimum respawn boosts and Nukes, respects Feet and Shield fates, revives downed players, and recharges Field Upgrades.',
      use: 'Best when downed teammates are close together; reload and prepare before teleporting into the hot zone.',
    },
    {
      id: 'round-off',
      name: 'Round Off',
      ...
      newInBo7: true,
      availableIn: ['BO7'],
      effect: 'On a round transition, prevents round advancement for two rounds.',
      doa4: 'Ends the active round if it is under round 60, with a 30-minute cooldown.',
      use: 'Creates breathing room for quest solving, regrouping, and recovery, especially when a squad cannot pause.',
    },
    {
      id: 'armor-gettin',
      name: 'Armor Gettin\'',
      rarity: 'legendary',
      type: 'instant',
      image: 'armorgettin.png',
      newInBo7: true,
      availableIn: ['BO7'],
      effect: 'Grants a three-plate Armor Vest and full plates.',
      doa4: 'Grants a one-plate Armor Vest and full plates, or refills plates if already vested.',
      use: 'Strong as an opening gum for long runs because it saves early Essence and boosts survivability immediately.',
    },
    {
      id: 'idle-eyes',
      name: 'Idle Eyes',
      ...
      image: 'idleeyes.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'For 30 seconds, zombies ignore players and stand idle.',
      doa4: 'Zombies ignore players and stay idle for 30 seconds.',
      use: 'Use it to complete interact-heavy quest steps, revive teammates, or reset a collapsing fight.',
    },
    {
      id: 'wall-power',
      name: 'Wall Power',
      ...
      image: 'wallpower.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'Your next wall-buy weapon comes Pack-a-Punched.',
      doa4: 'Electric poles do not damage you for one round.',
      use: 'Plan the wall-buy first, then chew it. It is best on a weapon with a useful nearby ammo source.',
    },
    {
      id: 'flavor-hex',
      name: 'Flavor Hex',
      ...
      image: 'flavorhex.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'Awards a random Ultra GobbleGum.',
      doa4: 'Awards a random Ultra GobbleGum.',
      use: 'Chew it when you have room to adapt, then hold or use the random Ultra effect at the right moment.',
    },
    {
      ...
      rarity: 'legendary',
      type: 'instant',
      image: 'immolationliquidation.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'Creates a Fire Sale Power-Up.',
      doa4: 'Holy Brimstone rains onto enemies for five minutes.',
      use: 'Coordinate players at different Mystery Box locations before activation to maximize cheap spins.',
    },
    {
      id: 'support-group',
      name: 'Support Group',
      rarity: 'legendary',
      type: 'instant',
      image: 'supportgroup.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'Grants ARC-XD, Mangler Cannon, Sentry Gun, and Disciple Injection in sequence.',
      doa4: 'For five minutes, normal arena item spawns become Cymbal Monkeys only; weapon and treasure spawns are unaffected.',
      use: 'Save it for boss fights or major Main Quest pressure, and make space before deploying each Support item.',
    },
    {
      id: 'phoenix-up',
      name: 'Phoenix Up',
      ...
      image: 'phoenixup.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'Revives all teammates and lets them keep their Perks.',
      doa4: 'Grants one extra life to you and every teammate.',
      use: 'Tell the squad if you are holding it; it can rescue scattered teammates from anywhere on the map.',
    },
    {
      id: 'modified-chaos',
      name: 'Modified Chaos',
      rarity: 'legendary',
      type: 'timed',
      image: 'modifiedchaos.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'For 1 minute, Ammo Mod cooldowns are greatly reduced.',
      doa4: 'Ammo Mod cooldowns are greatly reduced for one minute.',
      use: 'Equip Ammo Mods first, then use it during sustained fights where repeated elemental triggers add real damage.',
    },
    {
      id: 'on-the-house',
      name: 'On the House',
      rarity: 'legendary',
      type: 'instant',
      image: 'onthehouse.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'Creates a random Perk Power-Up.',
      doa4: 'A Slayer Mart purchase also delivers one extra random item.',
      use: 'Save it until core Perks are purchased so the random Perk is more likely to be something rare or remote.',
    },
    {
      id: 'wall-to-wall-clearance',
      name: 'Wall to Wall Clearance',
      rarity: 'legendary',
      type: 'timed',
      image: 'walltowallclearance.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'Weapon wall buys cost 10 Essence for 30 seconds.',
      doa4: 'A free Nuke deploys at your position every 10 seconds for two minutes.',
      use: 'Warn the squad first, then combine with Wall Power for an extremely cheap Pack-a-Punched wall weapon.',
    },
    {
      id: 'crate-power',
      name: 'Crate Power',
      rarity: 'legendary',
      type: 'conditional',
      image: 'cratepower.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'The next weapon you take from the Mystery Box is Pack-a-Punched.',
      doa4: 'Your next death does not remove gems.',
      use: 'Best early or during Fire Sale, especially with Wonderbar! when you want a packed Wonder Weapon.',
    },
    {
      id: 'gift-card',
      name: 'Gift Card',
      ...
      newInBo7: true,
      availableIn: ['BO7'],
      effect: 'Grants 30,000 Essence and cannot stack with other Essence bonuses.',
      doa4: 'Grants $30,000 for Slayer Mart spending.',
      use: 'Excellent for early acceleration, post-elimination recovery, or catching up after expensive door and upgrade buys.',
    },
    {
      id: 'perkaholic',
      name: 'Perkaholic',
      rarity: 'ultra',
      type: 'instant',
      image: 'perkaholic.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'Grants every available Perk to the user.',
      doa4: 'Awards a random Field Upgrade, a random Ammo Mod, a Level 1 Armor Vest, and a 30-minute chicken.',
      use: 'Chew early to save Essence, or keep one as a late-round recovery after losing Perks.',
    },
    {
      id: 'wonderbar',
      name: 'Wonderbar!',
      ...
      image: 'wonderbar.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'The next Mystery Box weapon you take is a Wonder Weapon.',
      doa4: 'For 30 minutes, each round starts with a coin flip that gives either Mutant form or a Chicken.',
      use: 'Use for quest-required Wonder Weapons, then stack with Crate Power or Respin Cycle if the box result needs help.',
    },
    {
      id: 'time-out',
      name: 'Time Out',
      ...
      image: 'timeout.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'For 3 minutes, clears Normal and Special enemies, ends the round, and pauses normal spawning.',
      doa4: 'For 30 minutes, a free Nuke Bomb drops within 30 seconds of each new Arena round.',
      use: 'Use late in a round to revive, shop, plan, or set up combo gums in safety.',
    },
    {
      ...
      rarity: 'ultra',
      type: 'timed',
      image: 'neardeathexperience.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'For 3 minutes or 5 revives, nearby players can revive or be revived while revived players keep Perks.',
      doa4: 'Each Nuke dropped in the next 10 seconds grants an extra life.',
      use: 'Pop before a dangerous fight so revives are easy and Perk losses do not spiral into a wipe.',
    },
    {
      id: 'reign-drops',
      name: 'Reign Drops',
      rarity: 'ultra',
      type: 'instant',
      image: 'reigndrops.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'Creates all core Power-Ups at once.',
      doa4: 'All items in the next Slayer Mart store are discounted by a random 20 to 50 percent.',
      use: 'A high-impact reset button for early momentum, quest pressure, or moments when the squad needs several buffs at once.',
    },
    {
      id: 'hidden-power',
      name: 'Hidden Power',
      rarity: 'ultra',
      type: 'instant',
      image: 'hiddenpower.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'Upgrades your currently held weapon to Legendary rarity.',
      doa4: 'For 10 minutes, every weapon pickup arrives at max power.',
      use: 'Use on the weapon you want to carry, especially early, then invest Salvage elsewhere.',
    },
    {
      id: 'newtonian-negation',
      name: 'Newtonian Negation',
      rarity: 'whimsical',
      type: 'timed',
      image: 'newtoniannegation.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'Killed zombies fall upward.',
      doa4: 'Fun-only visual effect.',
      use: 'Whimsical gums are cosmetic and best used when the squad wants a lighter run.',
    },
    {
      id: 'indigestion',
      name: 'Indigestion',
      ...
      availableIn: ['BO7', 'BO6'],
      effect: 'Killed zombies let out extreme gas effects.',
      doa4: 'Fun-only visual effect.',
      use: 'Pure comedy value with no gameplay advantage.',
    },
    {
      id: 'rainburps',
      name: 'Rainburps',
      ...
      image: 'rainburps.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'Killed zombies emit sparkly rainbow bubbles.',
      doa4: 'Fun-only visual effect.',
      use: 'Use when style matters more than optimization.',
    },
    {
      id: 'quacknarok',
      name: 'Quacknarok',
      rarity: 'whimsical',
      type: 'timed',
      image: 'quacknarock.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'Zombies appear with rubber ducky inner tubes.',
      doa4: 'Fun-only visual effect.',
      use: 'A novelty gum for casual runs and screenshots.',
    },
    {
      id: 'die-pitched',
      name: 'Die Pitched',
      rarity: 'whimsical',
      type: 'timed',
      image: 'diepitched.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'Zombies speak in high-pitched voices.',
      doa4: 'Fun-only audio effect.',
      use: 'Bring it when the match can afford a little chaos in the audio mix.',
    },
    {
      id: 'holiday-cheer',
      name: 'Holiday Cheer',
      rarity: 'whimsical',
      type: 'timed',
      image: 'hollidaycheer.png',
      availableIn: ['BO7', 'BO6'],
      effect: 'Zombies wear festive decorations.',
      doa4: 'Fun-only visual effect.',
      use: 'A seasonal-style cosmetic gum for casual play.',
    },
  ];

  const gobblegumGuide = {
    source: {
      title: 'Call of Duty | Black Ops 7 Round Based Zombies - GobbleGums',
      url: 'https://www.callofduty.com/guides/blackops7/zombies/gobblegums',
      published: 'November 12, 2025',
    },
    loadoutRules: [
      'Build GobbleGum Packs from the Zombies Loadout menu before launching a mission.',
      'The first three gums in the active pack are the three you start the match holding.',
      'You can hold no more than three GobbleGums at once.',
      'GobbleGum Machines pull from the currently active pack and avoid giving duplicates you already hold.',
      'If your stock is empty, the machine gives a Mr. Peeks flavorless gum with no special effect.',
      'Packs can be swapped from the pause menu during a mission; future machine pulls use the newly active pack.',
      'A gum from the machine must be collected, then activated normally.',
      'GobbleGums can also be earned, obtained, and used in Dead Ops Arcade 4.',
    ],
    activationTypes: [
      { name: 'Instant', summary: 'The effect happens as soon as you chew the gum.' },
      { name: 'Timed', summary: 'The effect starts after activation and lasts for a defined window.' },
      { name: 'Conditional', summary: 'The effect waits for a trigger, such as the next Perk buy, Power-Up, or Mystery Box pull.' },
    ],
    rarityOrder: ['ultra', 'legendary', 'epic', 'rare', 'whimsical'],
    teamNotes: [
      'Some gums affect only the user or the user\'s current weapon.',
      'Some gums affect the whole squad, such as round-control or revive effects.',
      'Power-Up spawning gums appear at the user, but the Power-Up itself benefits the living team when collected.',
    ],
    objectivePack: ['Perkaholic', 'Time Out', 'Phoenix Up', 'Arsenal Accelerator', 'Kill Joy', 'Shields Up'],
  };
  ...
  return { games, maps, characters, wonderWeapons, perks, timeline, sampleEE, classicEasterEggs, bo7EasterEggs, relics, gobblegumGuide };
})();
